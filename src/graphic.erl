...
draw_buttons(Panel, WxEnv, ServerInfo) ->
  ...
  wxStaticText:new(Panel, 8, "Missiles Speed:", [{pos, {50, 800}}, {size, {200, 20}}]),
  ...
  wxStaticText:new(Panel, 11, "Interception Error:", [{pos, {350, 800}}, {size, {200, 20}}]),
